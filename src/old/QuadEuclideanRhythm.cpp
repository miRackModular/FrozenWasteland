...
QuadEuclideanRhythmWidget::QuadEuclideanRhythmWidget(QuadEuclideanRhythm *module) : ModuleWidget(module) {
...

	{
		...
		panel->setBackground(SVG::load(assetPlugin(pluginInstance, "res/old/QuadEuclideanRhythm.svg")));
		addChild(panel);
	}
...
Model *modelQuadEuclideanRhythm_old = Model::create<QuadEuclideanRhythm, QuadEuclideanRhythmWidget>("Frozen Wasteland", "QuadEuclideanRhythm", "Quad Euclidean Rhythm (Legacy)", SEQUENCER_TAG);

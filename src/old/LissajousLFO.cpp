...
LissajousLFOWidget::LissajousLFOWidget(LissajousLFO *module) : ModuleWidget(module) {
...

	{
		...
		panel->setBackground(SVG::load(assetPlugin(pluginInstance, "res/old/LissajousLFO.svg")));
		addChild(panel);
	}
...
Model *modelLissajousLFO_old = Model::create<LissajousLFO, LissajousLFOWidget>("Frozen Wasteland", "LissajousLFO", "Lissajous LFO (Legacy)", LFO_TAG);
